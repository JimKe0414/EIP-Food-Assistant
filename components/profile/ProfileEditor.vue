...
function save() {
  emit('save', { ...draft, bodyFat: draft.bodyFat === null ? null : Number(draft.bodyFat) })
}
</script>
        ...
        <section ref="panel" class="profile-editor" role="dialog" aria-modal="true" aria-labelledby="profile-editor-title">
          ...
          <form @submit.prevent="save">
            <div class="form-grid">
              ...
              <label>骨骼肌量<input v-model.number="draft.muscle" type="number" min="10" max="80" step="0.1"><small>單位：kg</small></label>
